...
COMMANDS=[
 ['python','-m','py_compile','scripts/common.py','scripts/update_data.py','scripts/source_opportunity.py','scripts/source_security_facts.py','scripts/refresh_capital.py'],
