...
COMMANDS=[
 ['python','-m','py_compile','scripts/common.py','scripts/update_data.py','scripts/source_regime_official.py','scripts/source_segis.py','scripts/source_opportunity.py','scripts/source_security_facts.py','scripts/source_moea_dataset.py','scripts/source_twse_market_live.py','scripts/refresh_capital.py','scripts/capital_allocation.py','scripts/build_shadow_book.py','scripts/build_security_calibration.py','scripts/build_capital_decision_journal.py','scripts/build_opportunity_models.py','scripts/build_risk_budget_v2.py','scripts/build_risk_budget_v2_availability.py','scripts/build_validation_os.py','scripts/build_validation_os_v1_2.py','scripts/build_validation_os_v1_3.py','scripts/build_validation_targets.py','scripts/build_data_quality_slo.py','scripts/build_point_in_time_validation.py','scripts/build_decision_attribution.py','scripts/build_opportunity_frontier.py','scripts/build_statistical_challengers.py','scripts/build_decision_command.py','scripts/validate_decision_science_v2.py'],
 ['python','scripts/test_source_regime_official.py'],
 ...
 ['python','scripts/build_validation_targets.py','--check'],
